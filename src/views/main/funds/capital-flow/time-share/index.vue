    ...
    <el-card class="table-box">
      ...
      <div class="table-container">
        <el-table :data="tableData"
          ...
          <el-table-column prop="timeShareRentDepositBefore"
                           label="发生前余额"
                           min-width="140"></el-table-column>
          <el-table-column prop="timeShareRentDeposit"
                           label="发生后余额"
                           min-width="140"></el-table-column>
...
export default {
  ...
  created() {
    this.initSubject('timeShareRentDeposit')
    this.loadTableData()
  },
  methods: {
    loadFundsSum() {
    ...
    download(obj, s, e) {
      ...
      if (len === 0) {
        this.$message.warning('导出分时保证金为空，请重新查询')
      } else {
...
<style lang="scss">
.user-share-deposit .el-form-item__label {
  width: 100px;
}
</style>
