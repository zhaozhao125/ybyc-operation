    ...
    <el-card class="table-box">
      ...
      <div class="table-container">
        <el-table :data="tableData"
          ...
          <el-table-column prop="longTermRentCarDepositBefore"
                           label="发生前余额"
                           min-width="140"></el-table-column>
          <el-table-column prop="longTermRentCarDeposit"
                           label="发生后余额"
                           min-width="140"></el-table-column>
...
export default {
  ...
  created() {
    this.initSubject('longTermRentCarDeposit')
    this.loadTableData()
  },
  methods: {
    loadFundsSum() {
