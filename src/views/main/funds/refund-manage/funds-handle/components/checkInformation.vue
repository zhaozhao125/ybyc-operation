    ...
    <div class="x-data-detail">
        ...
        <el-row :gutter="10">
          <el-col :xs="24"
            ...
            <div class="x-detail-item">
              ...
              <div class="x-value">{{information.userMoneyText}}</div>
            </div>
          </el-col>
          <el-col :xs="24"
                  :sm="12"
            ...
            <div class="x-detail-item">
              ...
              <div class="x-value">{{information.amountRateText}}</div>
            </div>
          </el-col>
          <el-col :xs="24"
                  :sm="12"
          ...
          <el-col :xs="24"
            ...
            <div class="x-detail-item">
              ...
              <div class="x-value">{{information.userCancelDate | timeFilter}}</div>
            </div>
          </el-col>
        </el-row>
      </div>
      <div class="x-detail-block"
        ...
        <el-table :data="accountList"
                  style="width: 100%">
          <el-table-column prop="returnDepositRecordId"
                           label="流水ID"
                           min-width="100">
          </el-table-column>
          <el-table-column prop="returnWayTypeText"
                           label="支付方式"
                           min-width="100">
          </el-table-column>
          ...
          <el-table-column prop="handleText"
                           label="审核状态"
                           min-width="100">
          </el-table-column>
          <el-table-column label="操作"
                           fixed="right"
                           min-width="70"
                           v-if="information.status === 'checkSuccess' || information.status === 'refunding'">
            <template slot-scope="scope">
              <el-popover placement="top"
                ...
                <div v-if="scope.row.returnWayType === 'bank_user'">
                  ...
                  <div style="text-align: right; margin: 0">
                    <el-button size="mini"
                               type="text"
                               @click="cancelRefund(scope.row)">退款失败</el-button>
                    <el-button type="primary"
                               size="mini"
                               @click="confirmRefund(scope.row)">退款成功</el-button>
                  </div>
                </div>
                <div v-else>
                  ...
                  <div style="text-align: right; margin: 0">
                    ...
                    <el-button type="primary"
                               size="mini"
                               @click="confirmRefund(scope.row)">确定</el-button>
                  </div>
                </div>
                <div slot="reference"
                     class="name-wrapper">
                  <el-button @click="scope.row.popoverShow = true"
                             type='text'
                             v-if="scope.row.handle === 'wait' && $_has('fundsHandleRefundAgree')">退款</el-button>
        ...
        <el-row :gutter="10">
          ...
          <el-col :xs="24"
            ...
            <div class="x-detail-item">
              ...
              <div class="x-value">{{information.auditorTime}}</div>
            </div>
          </el-col>
          <el-col :xs="24"
                  :sm="12"
            ...
            <div class="x-detail-item">
              ...
              <div class="x-value">{{information.auditor}}</div>
            </div>
          </el-col>
          <el-col :xs="24"
                  :sm="12"
          ...
          <el-col :xs="24"
                  :sm="12"
                  :md="8"
                  v-if="information.status === 'cancle'">
            <div class="x-detail-item">
...
export default {
  ...
  methods: {
    ...
    getInfor() {
      let params = this.searchData.cityIds ? { cityIds: this.searchData.cityIds, userApplyReturnDepositId: this.infor.userApplyReturnDepositId, cityType: 'belongTo' } : {
        userApplyReturnDepositId: this.infor.userApplyReturnDepositId,
        cityType: 'belongTo'
      }
      this.$service
        .refundHandelInfor(params)
        .then(res => {
