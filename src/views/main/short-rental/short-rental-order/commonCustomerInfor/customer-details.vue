<template>
  <div id="customer-details">
            ...
            <el-row :gutter="10" type="flex">
              ...
              <el-col :xs="24" :sm="12" :md="8">
                <div class="x-detail-item">
                  ...
                  <div class="x-value">
                    <span v-if="$_has('customerUserPhoneModified')">
                      <editInput v-has="'customerUserPhoneModified'" :name="userPhone" :value="detailData.userPhone" :type="typeNum" @updateVal="updateCustomer" ref="editInput"></editInput>
                    </span>
              ...
              <el-col :xs="24" :sm="12" :md="8">
                <div class="x-detail-item">
                  ...
                  <div class="x-value">
                    <span v-if="$_has('customerUserNameModified')">
                      <editInput v-has="'customerUserNameModified'" :name="userName" :value="detailData.userName" :type="typeText" @updateVal="updateCustomer"></editInput>
                    </span>
              ...
              <el-col :xs="24" :sm="12" :md="8">
                <div class="x-detail-item">
                  ...
                  <div class="x-value">
                    <span v-if="$_has('customerUserRoleModified')">
                      <editInput v-has="'customerUserRoleModified'" :name="userRoleId" :value="detailData.userRoleName" :type="typeRole" @updateVal="updateCustomer"></editInput>
                    </span>
              ...
              <el-col :xs="24" :sm="12" :md="8">
                <div class="x-detail-item">
                  ...
                  <div class="x-value">
                    <span v-if="$_has('customerUserIdentityNumberModified')">
                      <editInput v-has="'customerUserIdentityNumberModified'" :name="userIdentityNumber" :value="detailData.userIdentityNumber" :type="typeText" @updateVal="updateCustomer"></editInput>
                    </span>
              ...
              <el-col :xs="24" :sm="12" :md="8">
                <div class="x-detail-item">
                  ...
                  <div class="x-value">
                    <span v-if="$_has('customerDrivingLicenseExpireModified')">
                      <editInput v-has="'customerDrivingLicenseExpireModified'" :name="drivingLicenseExpire" :value="detailData.drivingLicenseExpire" :type="typeDate" @updateVal="updateCustomer"></editInput>
                    </span>
            ...
            <el-row :gutter="10">
              ...
              <el-col :xs="24" :sm="12" :md="8">
                <div class="x-detail-item">
                  ...
                  <div class="x-value">
                    <span v-if="$_has('customerIsAvoidTimeSharingDepositModified')">
                      <editInput v-has="'customerIsAvoidTimeSharingDepositModified'" :name="isAvoidTimeSharingDeposit" :value="detailData.isAvoidTimeSharingDeposit" :type="typeSelect" @updateVal="updateCustomer"></editInput>
                    </span>
              ...
              <el-col :xs="24" :sm="12" :md="8">
                <div class="x-detail-item">
                  ...
                  <div class="x-value">
                    <span v-if="$_has('customerIsAvoidFrozenMoneyModified')">
                      <editInput v-has="'customerIsAvoidFrozenMoneyModified'" :name="isAvoidFrozenMoney" :value="detailData.isAvoidFrozenMoney" :type="typeSelect" @updateVal="updateCustomer"></editInput>
                    </span>
              ...
              <el-col :xs="24" :sm="12" :md="8">
                <div class="x-detail-item">
                  ...
                  <div class="x-value">
                    <span v-if="$_has('customerIsAvoidCarFrozenMoneyModified')">
                      <editInput v-has="'customerIsAvoidCarFrozenMoneyModified'" :name="isAvoidCarFrozenMoney" :value="detailData.isAvoidCarFrozenMoney" :type="typeSelect" @updateVal="updateCustomer"></editInput>
                    </span>
              ...
              <el-col :xs="24" :sm="12" :md="8">
                <div class="x-detail-item">
                  ...
                  <div class="x-value">
                    ...
                    <el-button type="text" v-has="'customerSendCoupons'" @click="sendCouponsDialogVisible = true">发放优惠券</el-button>
                  </div>
                </div>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="10">
              ...
              <el-col :xs="24" :sm="12" :md="8">
                <div class="x-detail-item">
                  ...
                  <div class="x-value" v-if="detailData.sex">{{detailData.sex}}</div>
                  <div class="x-value" v-else>暂无</div>
                </div>
              </el-col>
              <el-col :xs="24" :sm="12" :md="8">
    ...
    <el-dialog title="查看用车密码" :visible.sync="pinDialogVisible" width="30%">
      <span>用车密码： {{detailData.userPin}}</span>
      <span slot="footer" class="dialog-footer">
    ...
    <el-dialog title="发放优惠券" :before-close="clearData" :visible.sync="sendCouponsDialogVisible" width="500px">
    ...
    <el-dialog title="查看优惠券" :visible.sync="couponsDialogVisible" width="90%" class="user-conpon-dialog" top="8vh">
        ...
        <div class="table-container">
          <el-table :data="couponsTableData" height="100%">
            ...
            <el-table-column label="操作" fixed="right" min-width="100px">
              <template slot-scope="scope">
                <el-button type="text" v-has="'customerDeleteCoupons'" @click="handleDelete(scope.row)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      counponsUserId: this.detailData.userId,
      couponsForm: {
        couponsId: '',
        remark: ''
      },
  ...
  methods: {
    ...
    handleReset() {
      this.$service
        .resetReserveCount({ userId: this.detailData.userId })
        .then(res => {
          if (res.data.code === '0') {
    ...
    handleSendMsg(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          let params = { user_id: this.detailData.userId, ...this.msgForm }
    ...
    getAssignedCoupons() {
      let params = { userId: this.detailData.userId }
    ...
    sendCoupons() {
      let params = {
        ...
        // modifiedBy: this.detailData.userId,
        // nickNameModifiedBy: this.detailData.userId,
        ...this.couponsForm
      }
      this.$service.assigneCoupons(params).then(res => {
        if (res.data.code == 0) {
          ...
          this.couponsForm = {}
          this.loadTableData()
          this.$emit('update', this.detailData.userId)
        }
      })
      this.sendCouponsDialogVisible = false
    },
