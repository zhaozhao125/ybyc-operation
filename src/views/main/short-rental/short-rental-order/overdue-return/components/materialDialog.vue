<template>
  <el-dialog
    ...
    width= '500px'
    >
    <el-form class="ovder_material_dialog" label-width="90px" labelPosition= 'left'>
      ...
      <el-form-item label="未还物料：" v-if="material.materielStatus==='returned'">
         <el-row  v-if="unreturn.length">
            <el-col :lg="6" :xl="4" v-for="item in unreturn" :key="item.id"><div>{{item.materielName}}</div></el-col>
          </el-row>
         <span v-else>无</span>
      </el-form-item>
    </el-form>
